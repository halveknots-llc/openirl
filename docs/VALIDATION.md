...
The compatibility validator checks the versioned matrix independently of the
prose documentation. It rejects revision drift, unsafe artifact paths,
sensitive evidence text, and high-maturity claims without exact
dependency, host, and artifact evidence. See [Compatibility Evidence](COMPATIBILITY.md).
