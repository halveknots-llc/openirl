        ...
        for idx,line in enumerate(path.read_text(encoding='utf-8', errors='replace').splitlines(),1):
            ...
            for pat in denied:
                if pat.search(line):
                    ...
                    break
    required_docs = ['docs/features/obs-reconciliation.md','docs/features/local-ingest.md','docs/features/encoder-profiles.md','docs/features/dashboard.md','docs/features/security.md','docs/features/brownout.md','docs/VALIDATION.md','docs/RELEASE_CHECKLIST.md','docs/RELEASE_PROVENANCE.md','docs/COMPATIBILITY.md','docs/contributing/README.md','compatibility/matrix-v1.json','.github/workflows/windows-package.yml']
